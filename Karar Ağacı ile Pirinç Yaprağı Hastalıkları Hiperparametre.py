#Konum listesindeki pirinç hastalığı görüntülerinin alınması
...
bakteri_yaprak_yanik="C:/Users/User/Desktop/rice_leaf_diseases/Bacterial leaf blight"
kahve_nokta="C:/Users/User/Desktop/rice_leaf_diseases/Brown spot"
yaprak_isi="C:/Users/User/Desktop/rice_leaf_diseases/Leaf smut"

def dosya(yol):
    return [os.path.join(yol,f) for f in os.listdir(yol)]

#Veri kümesindeki metin değerlerinin sayısallaştırılması
...
#Pirinç yaprağı hastalığı görsellerinin etiketlenmesi ve birleştirilmesi
...
#Veri setinin eğitim ve test olarak rastgele ayrılması
...
#Karar ağaçları modelinin oluşturulması ve eğitim/tahmin
#Karar ağacı hiperparametrelerinin tanımı ve GridSearchCV algoritmasının uygulanması
...
#Modelin sınıflarının ikili kodlaması
